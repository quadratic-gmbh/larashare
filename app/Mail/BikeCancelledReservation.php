...
class BikeCancelledReservation extends Mailable implements ShouldQueue
{
    ...
    {               
      $text = __('email.bike.cancelled_reservation.info') . "\n\n" . __('email.bike.cancelled_reservation.' . $this->suffix . '.text',[
        'timeframe' => $this->timeframe,
        'u_name' => $this->user_name,
        'b_name' => $this->bike_name
      ]);      
      $subject = __('email.bike.cancelled_reservation.' . $this->suffix .'.subject',['name' => $this->bike_name]);
